...
import { GetAlarmResponseDto } from './restapiResponse/get-alarm.dto';
import { PostRequestResponseDto } from './restapiResponse/post-reequest.dto';
  ...
  async postRequestFriend(
    ...
    try {
      const request = await axios.post(
        `${this.restApiUrl}/user/me/friend/request/${dto.userId}`,
        dto.friendRequestBody,
        {
          headers: {
            Authorization: dto.bearerToken,
          },
        },
      );
      return request.data;
